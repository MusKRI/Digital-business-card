...
function Card() {
  return (
    <div className="card__1">
      ...
      <div className="c1__myself flex">
        <h2 className="c1__Name">Laura Smith</h2>
        <h4>Frontend Developer</h4>
        <p>
          <a href="##">laurasmith.website</a>
        </p>

        <div className="c1__buttons">
          <a href="##" className="white__button">
            <i class="bx bxl-gmail"></i> <span>Email</span>
          </a>

          <a href="##" className="blue__button">
            <i class="bx bxl-linkedin-square"></i> <span>LinkedIn</span>
          </a>
        </div>
